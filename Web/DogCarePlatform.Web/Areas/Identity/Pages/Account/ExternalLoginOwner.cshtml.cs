namespace DogCarePlatform.Web.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        {
            return this.RedirectToPage("./LoginOwner");
        }

        public IActionResult OnPost(string provider, string returnUrl = null)
        {
            // Request a redirect to the external login provider.
            var redirectUrl = this.Url.Page("./ExternalLoginOwner", pageHandler: "Callback", values: new { returnUrl });
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (info == null)
            {
                this.ErrorMessage = "Възникна грешка при зареждането на вашият акаунт.";
